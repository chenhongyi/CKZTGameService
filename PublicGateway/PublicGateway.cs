...
namespace PublicGateway
{
    ...
    public class PublicGateway : StatelessService
    {
        ...
        public PublicGateway(StatelessServiceContext context) : base(context)
        {
        }
        ...
        protected override IEnumerable<ServiceInstanceListener> CreateServiceInstanceListeners()
        {
            return new[]
            {
                ...
                //new ServiceInstanceListener(        //http
                ...
                new ServiceInstanceListener(        //websocket
                    initParams => new WebSocketListener(null, "WebSocket", initParams, () => new PublicGatewayWebSocketConnectionHandler()),
